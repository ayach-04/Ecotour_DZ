...
type GuidePageProps = { lang: "en" | "fr" | "ar" }

export function GuidePage({ lang }: GuidePageProps) {
  return (
    <main className="text-zinc-900" dir={lang === "ar" ? "rtl" : "ltr"}>
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl mb-4">Guide</h1>
          <p className="text-xl text-zinc-500 max-w-md mx-auto">
            Something&apos;s coming — we&apos;re putting together a practical, low-impact guide for every terrain.
          </p>
        </motion.div>
      </div>
    </main>
